...
<h4> This guide describes how to create and configure the **Cisco Guest** switch (level 2 switch configured to prevent communication between devices inside the Guest VLAN). </h4>
    ...
    <li>Add VM
        <ol>
            ...
            <li>Drag the VM into the GNS3 project
                <ol>
                    <li>Connect "Gi0/0" port to the CiscoL2's "Gi1/1" port.</li>
                    <li>Connect "Gi0/1" port to the Guest-Win machine.</li>
                    <li>Connect "Gi0/2" port to the Guest-Kali machine.</li>
                    <li>Connect "Gi0/3" port to the Guest-Android machine.</li>
                </ol>
            </li>
        </ol>
    </li>
